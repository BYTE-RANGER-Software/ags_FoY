# -*- coding: utf-8 -*-
#
# FoY Verbs documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'FoYverbs', u'FoY Verbs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FoYVerbs', u'FoY Verbs Documentation',
     author, 'FoYVerbs', 'One line description of project.',
     'Miscellaneous'),
]
